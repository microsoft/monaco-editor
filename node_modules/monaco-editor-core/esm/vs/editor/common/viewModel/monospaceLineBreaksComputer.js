...
export class MonospaceLineBreaksComputerFactory {
    static create(options) {
        return new MonospaceLineBreaksComputerFactory(options.get(128 /* EditorOption.wordWrapBreakBeforeCharacters */), options.get(127 /* EditorOption.wordWrapBreakAfterCharacters */));
    }
