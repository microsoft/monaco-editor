...
export class TokenizationTextModelPart extends TextModelPart {
    constructor(_languageService, _languageConfigurationService, _textModel, _bracketPairsTextModelPart, _languageId) {
        super();
        ...
        this.grammarTokens = this._register(new GrammarTokens(this._languageService.languageIdCodec, this._textModel, () => this._languageId));
    ...
    refreshTokens(startLineNumber, endLineNumber) {
...
function initializeTokenization(textModel, languageId) {
