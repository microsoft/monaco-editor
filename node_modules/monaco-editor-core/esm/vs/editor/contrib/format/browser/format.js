    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            if (provider.canFormatMultipleRanges) {
                ...
                const result = (yield provider.provideDocumentRangeFormattingEdits(model, ranges[0], Object.assign(Object.assign({}, model.getFormattingOptions()), { ranges }), cts.token)) || [];
