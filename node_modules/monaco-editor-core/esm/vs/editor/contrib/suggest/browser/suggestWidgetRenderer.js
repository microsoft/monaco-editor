...
let ItemRenderer = class ItemRenderer {
    ...
    renderTemplate(container) {
        ...
        const configureFont = () => {
            ...
            const fontSize = options.get(114 /* EditorOption.suggestFontSize */) || fontInfo.fontSize;
            const lineHeight = options.get(115 /* EditorOption.suggestLineHeight */) || fontInfo.lineHeight;
        ...
        disposables.add(this._editor.onDidChangeConfiguration(e => {
            if (e.hasChanged(48 /* EditorOption.fontInfo */) || e.hasChanged(114 /* EditorOption.suggestFontSize */) || e.hasChanged(115 /* EditorOption.suggestLineHeight */)) {
                configureFont();
            }
        }));
    ...
    renderElement(element, index, data) {
        ...
        if (this._editor.getOption(113 /* EditorOption.suggest */).showInlineDetails) {
