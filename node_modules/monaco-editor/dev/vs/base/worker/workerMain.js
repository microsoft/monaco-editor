...
define(__m[23/*vs/nls*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    ...
    class ArrayQueue {
        ...
        */
        takeWhile(predicate) {
            ...
            let startIdx = this.c;
            while (startIdx < this.f.length && predicate(this.f[startIdx])) {
                startIdx++;
            }
            const result = startIdx === this.c ? null : this.f.slice(this.c, startIdx);
            this.c = startIdx;
            return result;
        }
        /**
        ...
        */
        takeFromEndWhile(predicate) {
            ...
            let endIdx = this.d;
            while (endIdx >= 0 && predicate(this.f[endIdx])) {
                endIdx--;
            }
            const result = endIdx === this.d ? null : this.f.slice(endIdx + 1, this.d + 1);
            this.d = endIdx;
            return result;
        }
        peek() {
        ...
        dequeue() {
            const result = this.f[this.c];
            this.c++;
            return result;
        }
        takeCount(count) {
            const result = this.f.slice(this.c, this.c + count);
            this.c += count;
            return result;
        }
    }
...
define(__m[25/*vs/base/common/cache*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[26/*vs/base/common/diff/diffChange*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[9/*vs/base/common/assert*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/errors*/]), function (require, exports, errors_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[14/*vs/base/common/iterator*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[27/*vs/base/common/keyCodes*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[28/*vs/base/common/lazy*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.Lazy = void 0;
    class Lazy {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[10/*vs/base/common/lifecycle*/], __M([0/*require*/,1/*exports*/,13/*vs/base/common/functional*/,14/*vs/base/common/iterator*/]), function (require, exports, functional_1, iterator_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    */
     ...
     *
     * Subclasses can {@linkcode q} disposables that will be automatically cleaned up when this object is disposed of.
     */
    class Disposable {
        constructor() {
            this.f = new DisposableStore();
            trackDisposable(this);
            setParentOfDisposable(this.f, this);
        }
        dispose() {
            markAsDisposed(this);
            this.f.dispose();
    ...
    class MutableDisposable {
        ...
        set value(value) {
            ...
            (_a = this.a) === null || _a === void 0 ? void 0 : _a.dispose();
            if (value) {
    ...
    class DisposableMap {
        ...
        set(key, value, skipDisposeOnOverwrite = false) {
            ...
            if (!skipDisposeOnOverwrite) {
                (_a = this.a.get(key)) === null || _a === void 0 ? void 0 : _a.dispose();
            }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[4/*vs/base/common/strings*/], __M([0/*require*/,1/*exports*/,25/*vs/base/common/cache*/,28/*vs/base/common/lazy*/]), function (require, exports, cache_1, lazy_1) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CodePointIterator {
        ...
        nextCodePoint() {
            const codePoint = getNextCodePoint(this.c, this.d, this.e);
            this.e += (codePoint >= 65536 /* Constants.UNICODE_SUPPLEMENTARY_PLANE_BEGIN */ ? 2 : 1);
            return codePoint;
        }
        eol() {
    ...
    class GraphemeIterator {
        ...
        constructor(str, offset = 0) {
            this.c = new CodePointIterator(str, offset);
        }
        nextGraphemeLength() {
    ...
    */
    ...
    class AmbiguousCharacters {
        static getInstance(locales) {
            return AmbiguousCharacters.d.get(Array.from(locales));
        }
        static getLocales() {
            return AmbiguousCharacters.e.value;
        }
        constructor(f) {
            this.f = f;
        }
    ...
    AmbiguousCharacters.c = new lazy_1.Lazy(() => {
    ...
    AmbiguousCharacters.d = new cache_1.LRUCachedFunction((locales) => {
    ...
    AmbiguousCharacters.e = new lazy_1.Lazy(() => Object.keys(AmbiguousCharacters.c.value).filter((k) => !k.startsWith('_')));
    ...
    class InvisibleCharacters {
        ...
        static e() {
            if (!this.d) {
                this.d = new Set(InvisibleCharacters.c());
            }
            return this.d;
        }
        static isInvisibleCharacter(codePoint) {
            return InvisibleCharacters.e().has(codePoint);
        }
        static get codePoints() {
            return InvisibleCharacters.e();
        }
    }
    InvisibleCharacters.d = undefined;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[29/*vs/base/common/hash*/], __M([0/*require*/,1/*exports*/,4/*vs/base/common/strings*/]), function (require, exports, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    StringSHA1.g = new DataView(new ArrayBuffer(320)); // 80 * 4 = 320
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[16/*vs/base/common/diff/diff*/], __M([0/*require*/,1/*exports*/,26/*vs/base/common/diff/diffChange*/,29/*vs/base/common/hash*/]), function (require, exports, diffChange_1, hash_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class DiffChangeHelper {
        ...
        MarkNextChange() {
            ...
            if (this.d > 0 || this.e > 0) {
                ...
                this.a.push(new diffChange_1.DiffChange(this.b, this.d, this.c, this.e));
            }
    ...
    class LcsDiff {
        ...
        constructor(originalSequence, modifiedSequence, continueProcessingPredicate = null) {
            ...
            const [originalStringElements, originalElementsOrHash, originalHasStrings] = LcsDiff.o(originalSequence);
            const [modifiedStringElements, modifiedElementsOrHash, modifiedHasStrings] = LcsDiff.o(modifiedSequence);
        ...
        q(originalIndex, newIndex) {
            ...
            const originalElement = LcsDiff.r(this.b, originalIndex);
            const modifiedElement = LcsDiff.r(this.c, newIndex);
...
define(__m[30/*vs/base/common/codicons*/], __M([0/*require*/,1/*exports*/,17/*vs/base/common/types*/]), function (require, exports, types_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[11/*vs/base/common/objects*/], __M([0/*require*/,1/*exports*/,17/*vs/base/common/types*/]), function (require, exports, types_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[18/*vs/base/common/uint*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[19/*vs/editor/common/core/characterClassifier*/], __M([0/*require*/,1/*exports*/,18/*vs/base/common/uint*/]), function (require, exports, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CharacterClassifier {
        constructor(_defaultValue) {
            ...
            this.c = defaultValue;
            this.a = CharacterClassifier.d(defaultValue);
            this.b = new Map();
        }
    ...
    class CharacterSet {
        constructor() {
            this.a = new CharacterClassifier(0 /* Boolean.False */);
        }
        add(charCode) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[31/*vs/editor/common/core/selection*/], __M([0/*require*/,1/*exports*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/]), function (require, exports, position_1, range_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[32/*vs/editor/common/core/wordCharacterClassifier*/], __M([0/*require*/,1/*exports*/,19/*vs/editor/common/core/characterClassifier*/]), function (require, exports, characterClassifier_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[20/*vs/editor/common/core/wordHelper*/], __M([0/*require*/,1/*exports*/,14/*vs/base/common/iterator*/,15/*vs/base/common/linkedList*/]), function (require, exports, iterator_1, linkedList_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[6/*vs/editor/common/diff/algorithms/diffAlgorithm*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.OffsetRange = exports.SequenceDiff = void 0;
    class SequenceDiff {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[33/*vs/editor/common/diff/algorithms/joinSequenceDiffs*/], __M([0/*require*/,1/*exports*/,6/*vs/editor/common/diff/algorithms/diffAlgorithm*/]), function (require, exports, diffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        for (let i = 1; i < sequenceDiffs.length; i++) {
            ...
            if (cur.seq1Range.isEmpty) {
                ...
                if (all) {
                    ...
                    result[result.length - 1] = new diffAlgorithm_1.SequenceDiff(lastResult.seq1Range, new diffAlgorithm_1.OffsetRange(lastResult.seq2Range.start, cur.seq2Range.endExclusive - length));
                    continue;
                }
            }
            result.push(cur);
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[34/*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/], __M([0/*require*/,1/*exports*/,6/*vs/editor/common/diff/algorithms/diffAlgorithm*/]), function (require, exports, diffAlgorithm_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    */
    class MyersDiffAlgorithm {
        compute(seq1, seq2) {
            ...
            if (seq1.length === 0) {
                return [new diffAlgorithm_1.SequenceDiff(new diffAlgorithm_1.OffsetRange(0, 0), new diffAlgorithm_1.OffsetRange(0, seq2.length))];
            }
            else if (seq2.length === 0) {
                return [new diffAlgorithm_1.SequenceDiff(new diffAlgorithm_1.OffsetRange(0, seq1.length), new diffAlgorithm_1.OffsetRange(0, 0))];
            }
            ...
            while (true) {
                ...
                if (endX !== lastAligningPosS1 || endY !== lastAligningPosS2) {
                    result.push(new diffAlgorithm_1.SequenceDiff(new diffAlgorithm_1.OffsetRange(endX, lastAligningPosS1), new diffAlgorithm_1.OffsetRange(endY, lastAligningPosS2)));
                }
                if (!path) {
                    break;
                }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[35/*vs/editor/common/diff/algorithms/utils*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[36/*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/], __M([0/*require*/,1/*exports*/,6/*vs/editor/common/diff/algorithms/diffAlgorithm*/,35/*vs/editor/common/diff/algorithms/utils*/]), function (require, exports, diffAlgorithm_1, utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        compute(sequence1, sequence2, equalityScore) {
            ...
            function reportDecreasingAligningPositions(s1, s2) {
                if (s1 + 1 !== lastAligningPosS1 || s2 + 1 !== lastAligningPosS2) {
                    result.push(new diffAlgorithm_1.SequenceDiff(new diffAlgorithm_1.OffsetRange(s1 + 1, lastAligningPosS1), new diffAlgorithm_1.OffsetRange(s2 + 1, lastAligningPosS2)));
                }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[21/*vs/editor/common/diff/linesDiffComputer*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[37/*vs/editor/common/diff/smartLinesDiffComputer*/], __M([0/*require*/,1/*exports*/,16/*vs/base/common/diff/diff*/,21/*vs/editor/common/diff/linesDiffComputer*/,4/*vs/base/common/strings*/,2/*vs/editor/common/core/range*/,9/*vs/base/common/assert*/]), function (require, exports, diff_1, linesDiffComputer_1, strings, range_1, assert_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
        ...
        computeDiff(originalLines, modifiedLines, options) {
            ...
            for (const c of result.changes) {
                ...
                if (c.originalEndLineNumber === 0) {
                    // Insertion
                    originalRange = new linesDiffComputer_1.LineRange(c.originalStartLineNumber + 1, c.originalStartLineNumber + 1);
                }
                else {
                    originalRange = new linesDiffComputer_1.LineRange(c.originalStartLineNumber, c.originalEndLineNumber + 1);
                }
                let modifiedRange;
                if (c.modifiedEndLineNumber === 0) {
                    // Deletion
                    modifiedRange = new linesDiffComputer_1.LineRange(c.modifiedStartLineNumber + 1, c.modifiedStartLineNumber + 1);
                }
                else {
                    modifiedRange = new linesDiffComputer_1.LineRange(c.modifiedStartLineNumber, c.modifiedEndLineNumber + 1);
                }
    ...
    class CharSequence {
        ...
        getEndLineNumber(i) {
            ...
            this.e(i, this.b);
            if (this.a[i] === 10 /* CharCode.LineFeed */) {
                return this.b[i] + 1;
            }
            return this.b[i];
        }
    ...
    class DiffComputer {
        constructor(originalLines, modifiedLines, opts) {
            ...
            this.l = createContinueProcessingPredicate(opts.maxComputationTime === 0 ? 0 : Math.min(opts.maxComputationTime, 5000)); // never run after 5s for character changes...
        }
        computeDiff() {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[38/*vs/editor/common/diff/standardLinesDiffComputer*/], __M([0/*require*/,1/*exports*/,9/*vs/base/common/assert*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,6/*vs/editor/common/diff/algorithms/diffAlgorithm*/,36/*vs/editor/common/diff/algorithms/dynamicProgrammingDiffing*/,33/*vs/editor/common/diff/algorithms/joinSequenceDiffs*/,34/*vs/editor/common/diff/algorithms/myersDiffAlgorithm*/,21/*vs/editor/common/diff/linesDiffComputer*/]), function (require, exports, assert_1, position_1, range_1, diffAlgorithm_1, dynamicProgrammingDiffing_1, joinSequenceDiffs_1, myersDiffAlgorithm_1, linesDiffComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.LineSequence = exports.lineRangeMappingFromRangeMappings = exports.StandardLinesDiffComputer = void 0;
    class StandardLinesDiffComputer {
        constructor() {
            this.b = new dynamicProgrammingDiffing_1.DynamicProgrammingDiffing();
            this.c = new myersDiffAlgorithm_1.MyersDiffAlgorithm();
        }
        computeDiff(originalLines, modifiedLines, options) {
            ...
            let lineAlignments = (() => {
                if (sequence1.length + sequence2.length < 1500) {
                    ...
                    return this.b.compute(sequence1, sequence2, (offset1, offset2) => originalLines[offset1] === modifiedLines[offset2]
                        ? modifiedLines[offset2].length === 0
                            ? 0.1
                            : 1 + Math.log(1 + modifiedLines[offset2].length)
                        : 0.99);
                }
                return this.c.compute(sequence1, sequence2);
            })();
            ...
            const scanForWhitespaceChanges = (equalLinesCount) => {
                for (let i = 0; i < equalLinesCount; i++) {
                    ...
                    if (originalLines[seq1Offset] !== modifiedLines[seq2Offset]) {
                        ...
                        const characterDiffs = this.e(originalLines, modifiedLines, new diffAlgorithm_1.SequenceDiff(new diffAlgorithm_1.OffsetRange(seq1Offset, seq1Offset + 1), new diffAlgorithm_1.OffsetRange(seq2Offset, seq2Offset + 1)));
            ...
            for (const diff of lineAlignments) {
                ...
                const characterDiffs = this.e(originalLines, modifiedLines, diff);
                for (const a of characterDiffs) {
                    alignments.push(a);
                }
            }
        ...
        e(originalLines, modifiedLines, diff) {
            ...
            const originalDiffs = sourceSlice.length + targetSlice.length < 500
                ? this.b.compute(sourceSlice, targetSlice)
                : this.c.compute(sourceSlice, targetSlice);
            let diffs = (0, joinSequenceDiffs_1.optimizeSequenceDiffs)(sourceSlice, targetSlice, originalDiffs);
    ...
    class LineSequence {
        ...
        getBoundaryScore(length) {
            const indentationBefore = length === 0 ? 0 : getIndentation(this.c[length - 1]);
            const indentationAfter = length === this.c.length ? 0 : getIndentation(this.c[length]);
    ...
    class Slice {
        constructor(lines, lineRange) {
            ...
            let chars = 0;
            this.c = new Int32Array(lineRange.length);
            for (let i = lineRange.start; i < lineRange.endExclusive; i++) {
                const line = lines[i];
                chars += line.length;
                this.c[i - lineRange.start] = chars + 1;
                chars++;
            }
            this.b = new Int32Array(chars);
            let offset = 0;
            for (let i = lineRange.start; i < lineRange.endExclusive; i++) {
                const line = lines[i];
                for (let i = 0; i < line.length; i++) {
                    this.b[offset + i] = line.charCodeAt(i);
                }
                offset += line.length;
                if (i < lines.length - 1) {
                    this.b[offset] = '\n'.charCodeAt(0);
        ...
        translateOffset(offset) {
            ...
            const offsetOfPrevLineBreak = i === 0 ? 0 : this.c[i - 1];
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[39/*vs/editor/common/diff/linesDiffComputers*/], __M([0/*require*/,1/*exports*/,37/*vs/editor/common/diff/smartLinesDiffComputer*/,38/*vs/editor/common/diff/standardLinesDiffComputer*/]), function (require, exports, smartLinesDiffComputer_1, standardLinesDiffComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[40/*vs/editor/common/languages/linkComputer*/], __M([0/*require*/,1/*exports*/,19/*vs/editor/common/core/characterClassifier*/]), function (require, exports, characterClassifier_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class LinkComputer {
        ...
        static computeLinks(model, stateMachine = getStateMachine()) {
            ...
            for (let i = 1, lineCount = model.getLineCount(); i <= lineCount; i++) {
                ...
                while (j < len) {
                    ...
                    if (state === 13 /* State.Accept */) {
                        ...
                        if (chClass === 1 /* CharacterClass.ForceTermination */) {
                            result.push(LinkComputer.a(classifier, line, i, linkBeginIndex, j));
                ...
                if (state === 13 /* State.Accept */) {
                    result.push(LinkComputer.a(classifier, line, i, linkBeginIndex, len));
                }
            }
            return result;
        }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[41/*vs/editor/common/languages/supports/inplaceReplaceSupport*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[42/*vs/editor/common/model*/], __M([0/*require*/,1/*exports*/,11/*vs/base/common/objects*/]), function (require, exports, objects_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[43/*vs/editor/common/model/prefixSumComputer*/], __M([0/*require*/,1/*exports*/,24/*vs/base/common/arrays*/,18/*vs/base/common/uint*/]), function (require, exports, arrays_1, uint_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    */
    class ConstantTimePrefixSumComputer {
        ...
        insertValues(insertIndex, insertArr) {
            this.a = (0, arrays_1.arrayInsert)(this.a, insertIndex, insertArr);
            this.f(insertIndex);
        }
        f(index) {
            this.b = false;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[44/*vs/editor/common/model/mirrorTextModel*/], __M([0/*require*/,1/*exports*/,4/*vs/base/common/strings*/,3/*vs/editor/common/core/position*/,43/*vs/editor/common/model/prefixSumComputer*/]), function (require, exports, strings_1, position_1, prefixSumComputer_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class MirrorTextModel {
        ...
        getText() {
            if (this.j === null) {
                this.j = this.d.join(this.f);
            }
            return this.j;
        }
        onEvents(e) {
            if (e.eol && e.eol !== this.f) {
                this.f = e.eol;
                this.h = null;
            }
            // Update my lines
            ...
            for (const change of changes) {
                this.n(change.range);
                this.o(new position_1.Position(change.range.startLineNumber, change.range.startColumn), change.text);
            }
            this.g = e.versionId;
            this.j = null;
        }
        k() {
            if (!this.h) {
                const eolLength = this.f.length;
                const linesLength = this.d.length;
                const lineStartValues = new Uint32Array(linesLength);
                for (let i = 0; i < linesLength; i++) {
                    lineStartValues[i] = this.d[i].length + eolLength;
                }
                this.h = new prefixSumComputer_1.PrefixSumComputer(lineStartValues);
            }
        }
        /**
         * All changes to a line's text go through this method
         */
        l(lineIndex, newValue) {
            this.d[lineIndex] = newValue;
            if (this.h) {
                // update prefix sum
                this.h.setValue(lineIndex, this.d[lineIndex].length + this.f.length);
            }
        }
        n(range) {
            if (range.startLineNumber === range.endLineNumber) {
                ...
                this.l(range.startLineNumber - 1, this.d[range.startLineNumber - 1].substring(0, range.startColumn - 1)
                    + this.d[range.startLineNumber - 1].substring(range.endColumn - 1));
                return;
            }
            // Take remaining text on last line and append it to remaining text on first line
            this.l(range.startLineNumber - 1, this.d[range.startLineNumber - 1].substring(0, range.startColumn - 1)
                + this.d[range.endLineNumber - 1].substring(range.endColumn - 1));
            // Delete middle lines
            this.d.splice(range.startLineNumber, range.endLineNumber - range.startLineNumber);
            if (this.h) {
                // update prefix sum
                this.h.removeValues(range.startLineNumber, range.endLineNumber - range.startLineNumber);
            }
        }
        o(position, insertText) {
            ...
            if (insertLines.length === 1) {
                ...
                this.l(position.lineNumber - 1, this.d[position.lineNumber - 1].substring(0, position.column - 1)
                    + insertLines[0]
                    + this.d[position.lineNumber - 1].substring(position.column - 1));
                return;
            }
            // Append overflowing text from first line to the end of text to insert
            insertLines[insertLines.length - 1] += this.d[position.lineNumber - 1].substring(position.column - 1);
            ...
            for (let i = 1; i < insertLines.length; i++) {
                this.d.splice(position.lineNumber + i - 1, 0, insertLines[i]);
                newLengths[i - 1] = insertLines[i].length + this.f.length;
            }
            if (this.h) {
                // update prefix sum
                this.h.insertValues(position.lineNumber, newLengths);
            }
        }
    }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[45/*vs/editor/common/model/textModelSearch*/], __M([0/*require*/,1/*exports*/,4/*vs/base/common/strings*/,32/*vs/editor/common/core/wordCharacterClassifier*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,42/*vs/editor/common/model*/]), function (require, exports, strings, wordCharacterClassifier_1, position_1, range_1, model_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class TextModelSearch {
        static findMatches(model, searchParams, searchRange, captureMatches, limitResultCount) {
            ...
            if (searchData.regex.multiline) {
                return this.b(model, searchRange, new Searcher(searchData.wordSeparators, searchData.regex), captureMatches, limitResultCount);
            }
        ...
        static b(model, searchRange, searcher, captureMatches, limitResultCount) {
            ...
            while ((m = searcher.next(text))) {
                result[counter++] = createFindMatch(this.a(model, deltaOffset, text, lfCounter, m.index, m[0]), m, captureMatches);
        ...
        static e(model, searchStart, searcher, captureMatches) {
            ...
            if (m) {
                return createFindMatch(this.a(model, deltaOffset, text, lfCounter, m.index, m[0]), m, captureMatches);
            }
            if (searchStart.lineNumber !== 1 || searchStart.column !== 1) {
                // Try again from the top
                return this.e(model, new position_1.Position(1, 1), searcher, captureMatches);
            }
            return null;
        }
        ...
        static h(model, searchStart, searcher, captureMatches) {
            const matches = this.b(model, new range_1.Range(1, 1, searchStart.lineNumber, searchStart.column), searcher, captureMatches, 10 * LIMIT_FIND_COUNT);
            if (matches.length > 0) {
            ...
            if (searchStart.lineNumber !== lineCount || searchStart.column !== model.getLineMaxColumn(lineCount)) {
                ...
                return this.h(model, new position_1.Position(lineCount, model.getLineMaxColumn(lineCount)), searcher, captureMatches);
            }
            return null;
        }
            ...
            do {
                ...
                if (matchStartIndex === this.b && matchLength === this.c) {
                    if (matchLength === 0) {
                        ...
                        if (strings.getNextCodePoint(text, textLength, this.a.lastIndex) > 0xFFFF) {
                            this.a.lastIndex += 2;
                        }
                        else {
                            this.a.lastIndex += 1;
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[46/*vs/editor/common/services/unicodeTextModelHighlighter*/], __M([0/*require*/,1/*exports*/,2/*vs/editor/common/core/range*/,45/*vs/editor/common/model/textModelSearch*/,4/*vs/base/common/strings*/,9/*vs/base/common/assert*/,20/*vs/editor/common/core/wordHelper*/]), function (require, exports, range_1, textModelSearch_1, strings, assert_1, wordHelper_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CodePointHighlighter {
        constructor(b) {
            ...
            this.ambiguousCharacters = strings.AmbiguousCharacters.getInstance(new Set(b.allowedLocales));
        }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[47/*vs/editor/common/standalone/standaloneEnums*/], __M([0/*require*/,1/*exports*/]), function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[48/*vs/nls!vs/base/common/platform*/], __M([23/*vs/nls*/,55/*vs/nls!vs/base/common/worker/simpleWorker*/]), function(nls, data) { return nls.create("vs/base/common/platform", data); });
define(__m[5/*vs/base/common/platform*/], __M([0/*require*/,1/*exports*/,48/*vs/nls!vs/base/common/platform*/]), function (require, exports, nls) {
    "use strict";
    var _a;
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[49/*vs/base/common/process*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[50/*vs/base/common/path*/], __M([0/*require*/,1/*exports*/,49/*vs/base/common/process*/]), function (require, exports, process) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[22/*vs/base/common/stopwatch*/], __M([0/*require*/,1/*exports*/,5/*vs/base/common/platform*/]), function (require, exports, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class StopWatch {
        ...
        constructor(highResolution) {
            this.a = hasPerformanceNow && highResolution;
            this.b = this.d();
            this.c = -1;
        }
        stop() {
        ...
        d() {
            return this.a ? platform_1.globals.performance.now() : Date.now();
        }
    }
    exports.StopWatch = StopWatch;
});

define(__m[7/*vs/base/common/event*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/errors*/,13/*vs/base/common/functional*/,10/*vs/base/common/lifecycle*/,15/*vs/base/common/linkedList*/,22/*vs/base/common/stopwatch*/]), function (require, exports, errors_1, functional_1, lifecycle_1, linkedList_1, stopwatch_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    (function (Event) {
        ...
        class ChainableEvent {
            constructor(event) {
                this.event = event;
                this.c = new lifecycle_1.DisposableStore();
            }
            map(fn) {
                return new ChainableEvent(map(this.event, fn, this.c));
            }
            forEach(fn) {
                return new ChainableEvent(forEach(this.event, fn, this.c));
            }
            filter(fn) {
                return new ChainableEvent(filter(this.event, fn, this.c));
            }
            reduce(merge, initial) {
                return new ChainableEvent(reduce(this.event, merge, initial, this.c));
            }
            latch() {
    ...
    class EventProfiling {
        constructor(name) {
            ...
            this.durations = [];
            this.name = `${name}_${EventProfiling.c++}`;
            EventProfiling.all.add(this);
        }
        start(listenerCount) {
            this.d = new stopwatch_1.StopWatch(true);
            this.listenerCount = listenerCount;
        }
        stop() {
            if (this.d) {
                const elapsed = this.d.elapsed();
    ...
    class LeakageMonitor {
        ...
        dispose() {
            var _a;
            (_a = this.c) === null || _a === void 0 ? void 0 : _a.clear();
        }
        check(stack, listenerCount) {
            ...
            const count = (this.c.get(stack.value) || 0);
            this.c.set(stack.value, count + 1);
            this.d -= 1;
            if (this.d <= 0) {
                // only warn on first exceed and then every time the limit
                // is exceeded by 50% again
                this.d = threshold * 0.5;
                // find most frequent listener and print warning
                let topStack;
                let topCount = 0;
                for (const [stack, count] of this.c) {
    ...
    class Emitter {
        constructor(options) {
            ...
            this.j = false;
            this.d = options;
            this.f = _globalLeakWarningThreshold > 0 || ((_a = this.d) === null || _a === void 0 ? void 0 : _a.leakWarningThreshold) ? new LeakageMonitor((_c = (_b = this.d) === null || _b === void 0 ? void 0 : _b.leakWarningThreshold) !== null && _c !== void 0 ? _c : _globalLeakWarningThreshold) : undefined;
            this.g = ((_d = this.d) === null || _d === void 0 ? void 0 : _d._profName) ? new EventProfiling(this.d._profName) : undefined;
            this.m = (_e = this.d) === null || _e === void 0 ? void 0 : _e.deliveryQueue;
        }
        dispose() {
            var _a, _b, _c, _d;
            if (!this.j) {
                ...
                if (this.n) {
                    if (_enableDisposeWithListenerWarning) {
                        const listeners = Array.from(this.n);
                        queueMicrotask(() => {
                            var _a;
                ...
                (_a = this.m) === null || _a === void 0 ? void 0 : _a.clear(this);
                (_c = (_b = this.d) === null || _b === void 0 ? void 0 : _b.onDidRemoveLastListener) === null || _c === void 0 ? void 0 : _c.call(_b);
                (_d = this.f) === null || _d === void 0 ? void 0 : _d.dispose();
            }
        }
        /**
        ...
        get event() {
            if (!this.l) {
                this.l = (callback, thisArgs, disposables) => {
                    var _a, _b, _c;
                    if (!this.n) {
                        this.n = new linkedList_1.LinkedList();
                    }
                    if (this.f && this.n.size > this.f.threshold * 3) {
                        console.warn(`[${this.f.name}] REFUSES to accept new listeners because it exceeded its threshold by far`);
                        return lifecycle_1.Disposable.None;
                    }
                    const firstListener = this.n.isEmpty();
                    if (firstListener && ((_a = this.d) === null || _a === void 0 ? void 0 : _a.onWillAddFirstListener)) {
                        this.d.onWillAddFirstListener(this);
                    }
                    let removeMonitor;
                    let stack;
                    if (this.f && this.n.size >= Math.ceil(this.f.threshold * 0.2)) {
                        // check and record this emitter for potential leakage
                        stack = Stacktrace.create();
                        removeMonitor = this.f.check(stack, this.n.size + 1);
                    }
                    if (_enableDisposeWithListenerWarning) {
                        stack = stack !== null && stack !== void 0 ? stack : Stacktrace.create();
                    }
                    const listener = new Listener(callback, thisArgs, stack);
                    const removeListener = this.n.push(listener);
                    if (firstListener && ((_b = this.d) === null || _b === void 0 ? void 0 : _b.onDidAddFirstListener)) {
                        this.d.onDidAddFirstListener(this);
                    }
                    if ((_c = this.d) === null || _c === void 0 ? void 0 : _c.onDidAddListener) {
        ...
        fire(event) {
            ...
            if (this.n) {
                ...
                // the driver of this
                if (!this.m) {
                    this.m = new PrivateEventDeliveryQueue();
                }
                for (const listener of this.n) {
                    this.m.push(this, listener, event);
                }
                // start/stop performance insight collection
                (_a = this.g) === null || _a === void 0 ? void 0 : _a.start(this.m.size);
                this.m.deliver();
                (_b = this.g) === null || _b === void 0 ? void 0 : _b.stop();
            }
        }
        hasListeners() {
            if (!this.n) {
    ...
    class EventDeliveryQueue {
        constructor() {
            this.c = new linkedList_1.LinkedList();
        }
        get size() {
            return this.c.size;
        }
        push(emitter, listener, event) {
            this.c.push(new EventDeliveryQueueElement(emitter, listener, event));
        }
        clear(emitter) {
    ...
    class PauseableEmitter extends Emitter {
        constructor(options) {
            super(options);
            this.c = 0;
            this.h = new linkedList_1.LinkedList();
            this.k = options === null || options === void 0 ? void 0 : options.merge;
        }
        pause() {
            this.c++;
        }
        resume() {
            if (this.c !== 0 && --this.c === 0) {
                if (this.k) {
                    ...
                    if (this.h.size > 0) {
                        const events = Array.from(this.h);
                        this.h.clear();
                        super.fire(this.k(events));
                    }
                }
                else {
                    // no merging, fire each event individually and test
                    // that this emitter isn't paused halfway through
                    while (!this.c && this.h.size !== 0) {
                        super.fire(this.h.shift());
                    }
                }
            }
        }
    ...
    class DebounceEmitter extends PauseableEmitter {
        constructor(options) {
            var _a;
            super(options);
            this.o = (_a = options.delay) !== null && _a !== void 0 ? _a : 100;
        }
        fire(event) {
            if (!this.p) {
                this.pause();
    ...
    class MicrotaskEmitter extends Emitter {
        constructor(options) {
            super(options);
            this.c = [];
            this.h = options === null || options === void 0 ? void 0 : options.merge;
        }
        fire(event) {
    ...
    class EventMultiplexer {
        ...
        g() {
            this.d = true;
            this.f.forEach(e => this.j(e));
        }
        h() {
            this.d = false;
            this.f.forEach(e => this.k(e));
        }
        j(e) {
            e.listener = e.event(r => this.c.fire(r));
        }
        k(e) {
            if (e.listener) {
                e.listener.dispose();
    ...
    class EventBufferer {
        ...
        wrapEvent(event) {
            return (listener, thisArgs, disposables) => {
                return event(i => {
                    const buffer = this.c[this.c.length - 1];
                    if (buffer) {
    ...
    class Relay {
        constructor() {
            this.c = false;
            this.d = Event.None;
            this.f = lifecycle_1.Disposable.None;
            this.g = new Emitter({
                onDidAddFirstListener: () => {
                    this.c = true;
                    this.f = this.d(this.g.fire, this.g);
                },
                onDidRemoveLastListener: () => {
                    this.c = false;
                    this.f.dispose();
        ...
        set input(event) {
            ...
            if (this.c) {
                this.f.dispose();
                this.f = event(this.g.fire, this.g);
            }
        }
        dispose() {
            this.f.dispose();
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[51/*vs/base/common/cancellation*/], __M([0/*require*/,1/*exports*/,7/*vs/base/common/event*/]), function (require, exports, event_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class CancellationTokenSource {
        ...
        dispose(cancel = false) {
            ...
            (_a = this.b) === null || _a === void 0 ? void 0 : _a.dispose();
            if (!this.a) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[12/*vs/base/common/uri*/], __M([0/*require*/,1/*exports*/,50/*vs/base/common/path*/,5/*vs/base/common/platform*/]), function (require, exports, paths, platform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[56/*vs/base/common/worker/simpleWorker*/], __M([0/*require*/,1/*exports*/,8/*vs/base/common/errors*/,7/*vs/base/common/event*/,10/*vs/base/common/lifecycle*/,11/*vs/base/common/objects*/,5/*vs/base/common/platform*/,4/*vs/base/common/strings*/]), function (require, exports, errors_1, event_1, lifecycle_1, objects_1, platform_1, strings) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class SimpleWorkerProtocol {
        ...
        k(requestMessage) {
            ...
            result.then((r) => {
                ...
                this.o(new ReplyMessage(this.a, req, undefined, (0, errors_1.transformErrorForSerialization)(e)));
            });
        }
        l(msg) {
            const req = msg.req;
    ...
    class SimpleWorkerClient extends lifecycle_1.Disposable {
        constructor(workerFactory, moduleId, host) {
            ...
            this.a = this.q(workerFactory.create('vs/base/common/worker/simpleWorker', (msg) => {
            ...
            const proxyMethodRequest = (method, args) => {
                return this.h(method, args);
            };
            const proxyListen = (eventName, arg) => {
                return this.c.listen(eventName, arg);
            };
            this.g = new Promise((resolve, reject) => {
                lazyProxyReject = reject;
                this.b.then((availableMethods) => {
                    resolve(createProxyObject(availableMethods, proxyMethodRequest, proxyListen));
                }, (e) => {
                    reject(e);
                    this.j('Worker failed to load ' + moduleId, e);
                });
            });
        }
        getProxyObject() {
    ...
    class SimpleWorkerServer {
        ...
        g(workerId, loaderConfig, moduleId, hostMethods) {
            ...
            if (this.a) {
                ...
                return Promise.resolve((0, objects_1.getAllMethodNames)(this.b));
            }
            if (loaderConfig) {
            ...
            return new Promise((resolve, reject) => {
                ...
                req([moduleId], (module) => {
                    ...
                    resolve((0, objects_1.getAllMethodNames)(this.b));
                }, reject);
            });
        }
    }
...
define(__m[52/*vs/editor/common/tokenizationRegistry*/], __M([0/*require*/,1/*exports*/,7/*vs/base/common/event*/,10/*vs/base/common/lifecycle*/]), function (require, exports, event_1, lifecycle_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class TokenizationRegistry {
        ...
        register(language, support) {
            this.a.set(language, support);
            this.fire([language]);
            return (0, lifecycle_1.toDisposable)(() => {
                if (this.a.get(language) !== support) {
                    return;
                }
                this.a.delete(language);
                this.fire([language]);
            });
        }
        registerFactory(languageId, factory) {
            var _a;
            (_a = this.b.get(languageId)) === null || _a === void 0 ? void 0 : _a.dispose();
        ...
        get(language) {
            return (this.a.get(language) || null);
        }
    ...
    class TokenizationSupportFactoryData extends lifecycle_1.Disposable {
        ...
        j() {
            return __awaiter(this, void 0, void 0, function* () {
                const value = yield Promise.resolve(this.i.createTokenizationSupport());
                this.c = true;
                if (value && !this.a) {
                    this.q(this.g.register(this.h, value));
                }
            });
        }
    }
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[53/*vs/editor/common/languages*/], __M([0/*require*/,1/*exports*/,30/*vs/base/common/codicons*/,12/*vs/base/common/uri*/,2/*vs/editor/common/core/range*/,52/*vs/editor/common/tokenizationRegistry*/]), function (require, exports, codicons_1, uri_1, range_1, tokenizationRegistry_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
define(__m[54/*vs/editor/common/services/editorBaseApi*/], __M([0/*require*/,1/*exports*/,51/*vs/base/common/cancellation*/,7/*vs/base/common/event*/,27/*vs/base/common/keyCodes*/,12/*vs/base/common/uri*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,31/*vs/editor/common/core/selection*/,53/*vs/editor/common/languages*/,47/*vs/editor/common/standalone/standaloneEnums*/]), function (require, exports, cancellation_1, event_1, keyCodes_1, uri_1, position_1, range_1, selection_1, languages_1, standaloneEnums) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define(__m[57/*vs/editor/common/services/editorSimpleWorker*/], __M([0/*require*/,1/*exports*/,16/*vs/base/common/diff/diff*/,5/*vs/base/common/platform*/,12/*vs/base/common/uri*/,3/*vs/editor/common/core/position*/,2/*vs/editor/common/core/range*/,44/*vs/editor/common/model/mirrorTextModel*/,20/*vs/editor/common/core/wordHelper*/,40/*vs/editor/common/languages/linkComputer*/,41/*vs/editor/common/languages/supports/inplaceReplaceSupport*/,54/*vs/editor/common/services/editorBaseApi*/,22/*vs/base/common/stopwatch*/,46/*vs/editor/common/services/unicodeTextModelHighlighter*/,39/*vs/editor/common/diff/linesDiffComputers*/,11/*vs/base/common/objects*/]), function (require, exports, diff_1, platform_1, uri_1, position_1, range_1, mirrorTextModel_1, wordHelper_1, linkComputer_1, inplaceReplaceSupport_1, editorBaseApi_1, stopwatch_1, unicodeTextModelHighlighter_1, linesDiffComputers_1, objects_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    class MirrorModel extends mirrorTextModel_1.MirrorTextModel {
        ...
        getLineContent(lineNumber) {
            return this.d[lineNumber - 1];
        }
        getWordAtPosition(position, wordDefinition) {
            const wordAtText = (0, wordHelper_1.getWordAtText)(position.column, (0, wordHelper_1.ensureValidWordDefinition)(wordDefinition), this.d[position.lineNumber - 1], 0);
            if (wordAtText) {
        ...
        words(wordDefinition) {
            const lines = this.d;
            const wordenize = this.p.bind(this);
            let lineNumber = 0;
            let lineText = '';
            let wordRangesIdx = 0;
            let wordRanges = [];
        ...
        getLineWords(lineNumber, wordDefinition) {
            const content = this.d[lineNumber - 1];
            const ranges = this.p(content, wordDefinition);
            const words = [];
        ...
        getValueInRange(range) {
            range = this.q(range);
            if (range.startLineNumber === range.endLineNumber) {
                return this.d[range.startLineNumber - 1].substring(range.startColumn - 1, range.endColumn - 1);
            }
            const lineEnding = this.f;
            const startLineIndex = range.startLineNumber - 1;
            const endLineIndex = range.endLineNumber - 1;
            const resultLines = [];
            resultLines.push(this.d[startLineIndex].substring(range.startColumn - 1));
            for (let i = startLineIndex + 1; i < endLineIndex; i++) {
                resultLines.push(this.d[i]);
            }
            resultLines.push(this.d[endLineIndex].substring(0, range.endColumn - 1));
            return resultLines.join(lineEnding);
        }
        offsetAt(position) {
            position = this.r(position);
            this.k();
            return this.h.getPrefixSum(position.lineNumber - 2) + (position.column - 1);
        }
        positionAt(offset) {
            offset = Math.floor(offset);
            offset = Math.max(0, offset);
            this.k();
            const out = this.h.getIndexOf(offset);
            const lineLength = this.d[out.index].length;
        ...
        q(range) {
            const start = this.r({ lineNumber: range.startLineNumber, column: range.startColumn });
            const end = this.r({ lineNumber: range.endLineNumber, column: range.endColumn });
        ...
        r(position) {
            ...
            else if (lineNumber > this.d.length) {
                lineNumber = this.d.length;
                column = this.d[lineNumber - 1].length + 1;
                hasChanged = true;
            }
            else {
                const maxCharacter = this.d[lineNumber - 1].length + 1;
                if (column < 1) {
                    column = 1;
                    hasChanged = true;
                }
    ...
    class EditorSimpleWorker {
        ...
        j() {
            const all = [];
            Object.keys(this.d).forEach((key) => all.push(this.d[key]));
            return all;
        }
        acceptNewModel(data) {
            this.d[data.url] = new MirrorModel(uri_1.URI.parse(data.url), data.lines, data.EOL, data.versionId);
        }
        acceptModelChanged(strURL, e) {
            if (!this.d[strURL]) {
                return;
            }
            const model = this.d[strURL];
            model.onEvents(e);
        }
        acceptRemovedModel(strURL) {
            ...
            delete this.d[strURL];
        }
        computeUnicodeHighlights(url, options, range) {
            return __awaiter(this, void 0, void 0, function* () {
                const model = this.h(url);
                if (!model) {
        ...
        computeDiff(originalUrl, modifiedUrl, options, algorithm) {
            return __awaiter(this, void 0, void 0, function* () {
                const original = this.h(originalUrl);
                const modified = this.h(modifiedUrl);
                if (!original || !modified) {
                    return null;
                }
                return EditorSimpleWorker.k(original, modified, options, algorithm);
            });
        }
        static k(originalTextModel, modifiedTextModel, options, algorithm) {
            ...
            const identical = (result.changes.length > 0 ? false : this.l(originalTextModel, modifiedTextModel));
            return {
                identical,
                quitEarly: result.quitEarly,
        ...
        computeMoreMinimalEdits(modelUrl, edits) {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (let { range, text, eol } of edits) {
                    ...
                    if (Math.max(text.length, original.length) > EditorSimpleWorker.n) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                outer: for (const url of modelUrls) {
                    ...
                    for (const word of model.words(wordDefRegExp)) {
                        ...
                        seen.add(word);
                        if (seen.size > EditorSimpleWorker.o) {
                            break outer;
                        }
                    }
                }
        ...
        loadForeignModule(moduleId, createData, foreignHostMethods) {
            ...
            if (this.f) {
                this.g = this.f(ctx, createData);
                // static foreing module
                return Promise.resolve((0, objects_1.getAllMethodNames)(this.g));
            }
            // ESM-comment-begin
            return new Promise((resolve, reject) => {
                require([moduleId], (foreignModule) => {
                    this.g = foreignModule.create(ctx, createData);
                    resolve((0, objects_1.getAllMethodNames)(this.g));
                }, reject);
            });
            // ESM-comment-end
            // ESM-uncomment-begin
        ...
        fmr(method, args) {
            if (!this.g || typeof this.g[method] !== 'function') {
                return Promise.reject(new Error('Missing requestHandler or method: ' + method));
            }
            try {
                return Promise.resolve(this.g[method].apply(this.g, args));
            }
            catch (e) {
                return Promise.reject(e);
            }
    ...
    // ---- END diff --------------------------------------------------------------------------
    // ---- BEGIN minimal edits ---------------------------------------------------------------
    EditorSimpleWorker.n = 100000;
    // ---- BEGIN suggest --------------------------------------------------------------------------
    EditorSimpleWorker.o = 10000;
