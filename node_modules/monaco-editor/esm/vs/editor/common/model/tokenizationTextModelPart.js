...
import { DefaultBackgroundTokenizer, TokenizerWithStateStoreAndTextModel } from './textModelTokens.js';
...
class GrammarTokens extends Disposable {
    ...
    getLineTokens(lineNumber) {
        ...
        return this._tokens.getTokens(this._textModel.getLanguageId(), lineNumber - 1, lineText);
    }
    getTokenTypeIfInsertingCharacter(lineNumber, column, character) {
        if (!this._tokenizer) {
