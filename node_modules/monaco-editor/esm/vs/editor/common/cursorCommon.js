...
export class CursorConfiguration {
    static shouldRecreate(e) {
        return (e.hasChanged(139 /* EditorOption.layoutInfo */)
            || e.hasChanged(125 /* EditorOption.wordSeparators */)
            ...
            || e.hasChanged(123 /* EditorOption.useTabStops */)
            || e.hasChanged(48 /* EditorOption.fontInfo */)
            || e.hasChanged(87 /* EditorOption.readOnly */));
    }
    constructor(languageId, modelOptions, configuration, languageConfigurationService) {
        ...
        this.readOnly = options.get(87 /* EditorOption.readOnly */);
        ...
        this.useTabStops = options.get(123 /* EditorOption.useTabStops */);
        this.wordSeparators = options.get(125 /* EditorOption.wordSeparators */);
