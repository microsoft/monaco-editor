...
export let InlineCompletionsSource = class InlineCompletionsSource extends Disposable {
    ...
    clearSuggestWidgetInlineCompletions() {
        var _a;
        if ((_a = this.updateOperation.value) === null || _a === void 0 ? void 0 : _a.request.context.selectedSuggestionInfo) {
            this.updateOperation.clear();
        }
        this.suggestWidgetInlineCompletions.set(undefined, undefined);
    }
    update(position, context, activeInlineCompletion) {
        var _a, _b;
        const request = new UpdateRequest(position, context, this.textModel.getVersionId());
        const target = context.selectedSuggestionInfo ? this.suggestWidgetInlineCompletions : this.inlineCompletions;
        if ((_a = this.updateOperation.value) === null || _a === void 0 ? void 0 : _a.request.satisfies(request)) {
...
export class UpToDateInlineCompletions {
    ...
    constructor(inlineCompletionProviderResult, request, textModel, versionId) {
        ...
        this.versionId = versionId;
        this.refCount = 1;
        this.prependedInlineCompletionItems = [];
        this.counter = 0;
        this.rangeVersion = derived('ranges', reader => {
        ...
        this._inlineCompletions = inlineCompletionProviderResult.completions.map((i, index) => new InlineCompletionWithUpdatedRange(i, ids[index], this.rangeVersion));
    }
...
export class InlineCompletionWithUpdatedRange {
    ...
    toFilterTextReplacement(reader) {
