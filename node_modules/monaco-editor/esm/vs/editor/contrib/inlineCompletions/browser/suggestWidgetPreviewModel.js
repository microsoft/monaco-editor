...
let SuggestWidgetPreviewModel = class SuggestWidgetPreviewModel extends BaseGhostTextWidgetModel {
    ...
    get ghostText() {
        ...
        const suggestInlineCompletion = minimizeInlineCompletion(model, (_d = (_c = suggestWidgetState === null || suggestWidgetState === void 0 ? void 0 : suggestWidgetState.get()) === null || _c === void 0 ? void 0 : _c.selectedItem) === null || _d === void 0 ? void 0 : _d.normalizedInlineCompletion);
    ...
    toGhostText(completion, inlineCompletionPreviewLength) {
        const mode = this.editor.getOptions().get(113 /* EditorOption.suggest */).previewMode;
        return completion
