...
function renderHoverParts(participant, editor, themeService, hoverParts, context) {
    ...
    const widget = disposables.add(new ColorPickerWidget(context.fragment, model, editor.getOption(137 /* EditorOption.pixelRatio */), themeService, participant instanceof StandaloneColorPickerParticipant));
