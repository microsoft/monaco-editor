...
[![Contributor over time](https://contributor-graph-api.apiseven.com/contributors-svg?chart=contributorOverTime&repo=microsoft/monaco-editor)](https://www.apiseven.com/en/contributor-graph?chart=contributorOverTime&repo=microsoft/monaco-editor)
